...
def draw_wuxing_wheel(scores: dict):
    import numpy as np
    import matplotlib.pyplot as plt

    labels = list(scores.keys())
    values = np.array([scores[k] for k in labels])
...
def page_bazi(uid: str):
    ...
    st.pyplot(draw_wuxing_wheel(scores), use_container_width=True)
